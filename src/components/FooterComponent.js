...
function Footer(props) {
    return(
    <div className="footer" style={{background: "#3AAFA9"}}>
            ...
            <div className="row justify-content-center">             
                ...
                <div className="col-7 col-sm-5">
                    ...
                    <address>
		              ...
		              <i className="fa fa-envelope fa-lg"></i>: <a href="message@coalesceforum.com">
                         message@coalesceforum.com</a>
                    </address>
                </div>
